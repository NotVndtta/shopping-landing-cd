        ...
        <div className='absolute text-custom-black ph:font-semibold ph:px-[10px] ph:py-16 dp:font-bold dp:text-5xl dp:py-[70px] '>
          ...
          onSubmit={handleSubmit(onSubmit)}>
            ...
            <textarea className="ph:w-[258px] ph:h-[122px] ph:px-5 dp:w-[667px] dp:h-[122px] dp:pl-5 pt-[13px]  border 
                  border-[#E5E7EB] hover:border-[#7E3AF2] focus:border-[#7E3AF2] font-normal ph:text-sm dp:text-base rounded-2xl "
            ...
            <button className="ph:flex ph:ml-[21px] ph:mt-9 dp:ml-4 max-w-[188px] max-h-[50px] justify-between dp:mt-12 px-[25px] py-[13px]
